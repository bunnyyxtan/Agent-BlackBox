...
export async function POST(request: Request) {
  ...
  let body: { uploadJobId?: string; jobId?: string; storageProvider?: string };
  try {
    body = await readJsonRequest<{ uploadJobId?: string; jobId?: string; storageProvider?: string }>(request, {
